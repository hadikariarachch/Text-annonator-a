...
class Adaptor2 {
    ...
    getDescription(keyword, callback) {
        let ontology = 'NCIT';
        let fullOntologyName = "National Cancer Institute Thesaurus"
        ...
        request(url, function (err, res, body) {
            // console.log("Trying to send request from Adaptor 2, keyword is "+ keyword);
            if (err) {
                ...
                if (response.collection[0] && response.collection[0].definition[0]) {
                    ...
                    // console.log("Adaptor 2 result = "+ JSON.stringify(result));
...
module.exports.Adaptor2 = Adaptor2;